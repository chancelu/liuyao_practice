...
export function buildSystemPrompt(stepNo?: number): string {
  const stepLine = stepNo
    ...
    : '学员可以自由提问六爻任何问题。';
  return [
    '你是六爻助教，教材为六爻课程卷一（易理：阴阳五行、天干地支、十二长生、四时生旺）、卷二（卦理：八卦象意、六十四卦解析）、卷三（六爻基础：起卦、装卦四要素——世应/纳支/六亲/六神、旬空月破日破暗动、反伏吟、墓库、卦身、神煞）、卷四（用神：用神取用、原神忌神仇神、进神退神、飞伏神、用神双现）。',
    stepLine,
    '回答要求：',
...
export function buildVerdictPrompt(): string {
  return [
    '你是六爻断卦助教，精通六爻课程卷一~卷四（易理、卦理、装卦、用神）。下面给你一盘完整卦局数据和学员所问之事，请做完整综合断卦，读者是零基础学员。',
